...
//+kubebuilder:rbac:groups=demo,resources=movies,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=demo,resources=movies/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=demo,resources=movies/finalizers,verbs=update
